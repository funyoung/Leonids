...
public class ParticleSurface {
    ...
    private ParticleSurface(ViewGroup parentView, int maxParticles, long timeToLive) {
     ...
     */
    public ParticleSurface(ViewGroup parentView, int maxParticles, Drawable drawable, long timeToLive) {
     ...
     * @param timeToLive    The time to live for the particles
     */
    public ParticleSurface(Activity a, int maxParticles, int drawableRedId, long timeToLive) {
     ...
     */
    public ParticleSurface(Activity a, int maxParticles, int drawableRedId, long timeToLive, int parentViewId) {
     ...
     * @param timeToLive   The time to live for the particles
     */
    public ParticleSurface(Activity a, int maxParticles, Drawable drawable, long timeToLive) {
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    public ParticleSurface(Activity a, int maxParticles, Drawable drawable, long timeToLive, int parentViewId) {
     ...
     * @param timeToLive   The time to live for the particles
     */
    public ParticleSurface(Activity a, int maxParticles, Bitmap bitmap, long timeToLive) {
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    public ParticleSurface(Activity a, int maxParticles, Bitmap bitmap, long timeToLive, int parentViewId) {
     ...
     * @param timeToLive   The time to live for the particles
     */
    public ParticleSurface(Activity a, int maxParticles, AnimationDrawable animation, long timeToLive) {
     ...
     * @param parentViewId The view Id for the parent of the particle system
     */
    public ParticleSurface(Activity a, int maxParticles, AnimationDrawable animation, long timeToLive, int parentViewId) {
        this((ViewGroup) a.findViewById(parentViewId), maxParticles, timeToLive);
...
//        }
     ...
     * @return This.
     */
    public ParticleSurface setParentViewGroup(ViewGroup viewGroup) {
