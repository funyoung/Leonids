...
//        mParticles = new ArrayList<>();
    ...
    public ParticleSystem(ViewGroup parentView, int maxParticles, Drawable drawable, long timeToLive) {
        ...
        mDrawingView.initParticles(mMaxParticles, drawable);
    }
    ...
    public ParticleSystem(Activity a, int maxParticles, Bitmap bitmap, long timeToLive, int parentViewId) {
        ...
        mDrawingView.initParticles(mMaxParticles, bitmap);
    }
...
//        }
        mDrawingView.initParticles(mMaxParticles, animation);
    }
    ...
    public static void setFPS(double fps) {
        ParticleSurface.TIMER_TASK_INTERVAL = Math.round(1000 / fps);
    }
    ...
    public ParticleSystem setParentViewGroup(ViewGroup viewGroup) {
        ...
        if (mParentView != null) {
            ...
            mDrawingView.setParticleSystem(this);
        }
        return this;
    }

    public ParticleSystem setStartTime(long time) {
        mDrawingView.setStartTime(time);
        return this;
    }
    ...
    private void startEmitting(int particlesPerSecond) {
        mDrawingView.resetEmitting(particlesPerSecond);
        // Add a full size view to the parent view
        createParticleField();
        mDrawingView.updateParticlesBeforeStartTime(particlesPerSecond);
//        mTimer = new Timer();
//        mTimer.schedule(mTimerTask, 0, TIMER_TASK_INTERVAL);

//        mEmittingTime = -1; // Meaning infinite
        mDrawingView.setEmittingTime(-1);
        mDrawingView.resume();
    }
...
//        mEmittingTime = emittingTime;
        mDrawingView.setEmittingTime(emittingTime);
    ...
    private void startAnimator(Interpolator interpolator, long animnationTime) {
        ...
        mAnimator.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                mDrawingView.onUpdate(miliseconds);
            }
        });
...
//		mDrawingView.setParticles (mActiveParticles);
    ...
    public void activate(Particle p, long delay) {
